...
> For full project rules, coding standards, and architecture details, read `harness/claude.md` first. For task-specific context, read `harness/tasks/TASK-XXX.md`.
...
| File | When to read |
|------|-------------|
| `harness/claude.md` | Full coding standards and rules |
